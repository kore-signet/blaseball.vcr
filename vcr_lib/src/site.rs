...
static DOWNLOAD_PATH: &'static str = "/site/download";
...
pub struct PatchHeader {
    pub path: String,
    pub timestamp: u64,                 // millis
    pub hash: [u8; 28],                 // sha224
...
impl Serialize for ChronSiteUpdate {
        ...
        S: Serializer,
    {
        ...
        ser.serialize_field("timestamp", &Utc.timestamp_millis(self.timestamp as i64))?;
        ser.serialize_field("path", &self.path)?;
        ser.serialize_field("hash", &hex::encode(&self.hash))?;
