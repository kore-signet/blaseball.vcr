...
./target/release/build_entities -o tapes idols risingstars
...
./target/release/build_entities -o tapes -d ./zstd-dictionaries/librarystory.dict librarystory
./target/release/build_entities -o tapes nullified
./target/release/build_entities -o tapes fuelprogress
./target/release/build_entities -o tapes -c 100 team
./target/release/build_entities -o tapes -c 100 -d zstd-dictionaries/sim.dict sim
...
./target/release/build_entities -o tapes -c 100 -d zstd-dictionaries/stadium.dict stadium
